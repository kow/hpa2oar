...
void LLViewerMedia::updateMedia(void *dummy_arg)
{
	...
	LLPluginProcessParent::setUseReadThread((bool)PluginUseReadThread);
	...
	static LLCachedControl<bool> AudioStreamingMedia(gSavedSettings,"AudioStreamingMedia");
	bool inworld_media_enabled = AudioStreamingMedia;
	static LLCachedControl<bool> AudioStreamingMusic(gSavedSettings,"AudioStreamingMusic");
	bool inworld_audio_enabled = AudioStreamingMusic;
	static LLCachedControl<U32> PluginInstancesTotal(gSavedSettings,"PluginInstancesTotal");
	U32 max_instances = PluginInstancesTotal;
	static LLCachedControl<U32> PluginInstancesNormal(gSavedSettings,"PluginInstancesNormal");
	U32 max_normal = PluginInstancesNormal;
	static LLCachedControl<U32> PluginInstancesLow(gSavedSettings,"PluginInstancesLow");
	U32 max_low = PluginInstancesLow;
	static LLCachedControl<F32> PluginInstancesCPULimit(gSavedSettings,"PluginInstancesCPULimit");
	F32 max_cpu = PluginInstancesCPULimit;
	...
	static LLCachedControl<bool> MediaPerformanceManagerDebug(gSavedSettings,"MediaPerformanceManagerDebug");	
	if(MediaPerformanceManagerDebug)
	{
