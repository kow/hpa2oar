...
bool idle_startup()
{
	...
	static LLCachedControl<F32> PrecachingDelay(gSavedSettings,"PrecachingDelay");
	const F32 PRECACHING_DELAY = PrecachingDelay;
	...
	if (STATE_CLEANUP == LLStartUp::getStartupState())
	{
		...
		gLocalInventoryRoot = gInventory.createNewCategory(LLUUID::null, LLFolderType::FT_NONE, "Local Inventory");
		// </edit>
