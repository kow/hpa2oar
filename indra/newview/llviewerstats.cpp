...
void update_statistics(U32 frame_count)
{
	...
	LLViewerStats::getInstance()->setStat(LLViewerStats::ST_ENABLE_VBO, (F64)RenderVBOEnable);
	...
	LLViewerStats::getInstance()->setStat(LLViewerStats::ST_DRAW_DIST, (F64)RenderFarClip);
	static LLCachedControl<bool> UseChatBubbles(gSavedSettings,"UseChatBubbles");
	LLViewerStats::getInstance()->setStat(LLViewerStats::ST_CHAT_BUBBLES, (F64)UseChatBubbles);
#if 0 // 1.9.2
