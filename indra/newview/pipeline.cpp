...
void LLPipeline::createGLBuffers()
{
	...
	{ //screen space glow buffers
	  static LLCachedControl<S32> RenderGlowResolutionPow(gSavedSettings,"RenderGlowResolutionPow");
		const U32 glow_res = llmax(1, 
			llmin(512, 1 << (S32)RenderGlowResolutionPow));
...
U32 LLPipeline::addObject(LLViewerObject *vobj)
{
	...
	static LLCachedControl<bool> RenderDelayCreation(gSavedSettings,"RenderDelayCreation");
...
void LLPipeline::createObject(LLViewerObject* vobj)
{
	...
	static LLCachedControl<bool> RenderAnimateRes(gSavedSettings,"RenderAnimateRes");
...
void LLPipeline::renderBloom(BOOL for_snapshot, F32 zoom_factor, int subfield)
{
	...
	static LLCachedControl<U32> RenderResolutionDivisor(gSavedSettings,"RenderResolutionDivisor");
	...
	
	{
		...
		static LLCachedControl<F32> RenderGlowMinLuminance(gSavedSettings,"RenderGlowMinLuminance");
		F32 minLum = llmax((F32)RenderGlowMinLuminance, 0.0f);
		static LLCachedControl<F32> RenderGlowMaxExtractAlpha(gSavedSettings,"RenderGlowMaxExtractAlpha");
		F32 maxAlpha = RenderGlowMaxExtractAlpha;		
		static LLCachedControl<F32> RenderGlowWarmthAmount(gSavedSettings,"RenderGlowWarmthAmount");
		F32 warmthAmount = RenderGlowWarmthAmount;	
		static LLCachedControl<LLVector3> RenderGlowLumWeights(gSavedSettings,"RenderGlowLumWeights");
		LLVector3 lumWeights = RenderGlowLumWeights;
		static LLCachedControl<LLVector3> RenderGlowWarmthWeights(gSavedSettings,"RenderGlowWarmthWeights");
	...
	static LLCachedControl<S32> RenderGlowIterations(gSavedSettings,"RenderGlowIterations");
	S32 kernel = RenderGlowIterations*2;
	static LLCachedControl<F32> RenderGlowWidth(gSavedSettings,"RenderGlowWidth");
	...
	static LLCachedControl<F32> RenderGlowStrength(gSavedSettings,"RenderGlowStrength");
...
{	
	if (LLPipeline::sWaterReflections && assertInitialized() && LLDrawPoolWater::sNeedsReflectionUpdate)
	{
		...
		{	//generate planar reflection map
			...
			static LLCachedControl<S32> RenderReflectionDetail(gSavedSettings,"RenderReflectionDetail");		
