...
BOOL LLToolPie::handleDoubleClick(S32 x, S32 y, MASK mask)
{
	...
	static LLCachedControl<bool> double_click_auto_pilot(gSavedSettings, "DoubleClickAutoPilot");
	static LLCachedControl<bool> double_click_teleport(gSavedSettings, "DoubleClickTeleport");
	if (double_click_auto_pilot)
	{
		if (mPick.mPickType == LLPickInfo::PICK_LAND
...
BOOL LLToolPie::handleTooltipLand(std::string line, std::string tooltip_msg)
{
	...
	// 
	static LLCachedControl<bool> ShowLandHoverTip(gSavedSettings,"ShowLandHoverTip");
	if (!ShowLandHoverTip) return TRUE; 
...
BOOL LLToolPie::handleTooltipObject( LLViewerObject* hover_object, std::string line, std::string tooltip_msg)
{
	...
	else
	{
		...
		//
		static LLCachedControl<bool> ShowAllObjectHoverTip(gSavedSettings,"ShowAllObjectHoverTip");
		bool show_all_object_tips =
		(bool)ShowAllObjectHoverTip;			
...
{
	static LLUICachedControl<bool> ShowHoverTips ("ShowHoverTips", 0);
	if (!ShowHoverTips) return TRUE;
