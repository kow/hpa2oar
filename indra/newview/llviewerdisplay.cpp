...
void display_stats()
{
	...
	F32 fps_log_freq = FPSLogFrequency;
	...
	F32 mem_log_freq = MemoryLogFrequency;
...
void display(BOOL rebuild, F32 zoom_factor, int subfield, BOOL for_snapshot)
{
	...
	LLVOAvatar::sRenderName = AvatarNameTagMode;
	static LLCachedControl<bool> RenderShowGroupTitleAll(gSavedSettings,"RenderShowGroupTitleAll");
	LLVOAvatar::sRenderGroupTitles = RenderShowGroupTitleAll && AvatarNameTagMode;
	...
	if (!gDisconnected)
	{
		...
		static LLCachedControl<bool> UseOcclusion(gSavedSettings,"UseOcclusion");
		...
		static LLCachedControl<bool> RenderAutoMaskAlphaDeferred(gSavedSettings,"RenderAutoMaskAlphaDeferred");
		LLPipeline::sAutoMaskAlphaDeferred = RenderAutoMaskAlphaDeferred;
		static LLCachedControl<bool> RenderAutoMaskAlphaNonDeferred(gSavedSettings,"RenderAutoMaskAlphaNonDeferred");
		LLPipeline::sAutoMaskAlphaNonDeferred = RenderAutoMaskAlphaNonDeferred;
		...
		LLVOAvatar::sMaxVisible = (U32)RenderAvatarMaxVisible;
