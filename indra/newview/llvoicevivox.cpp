...
{
	static LLCachedControl<bool> EnableVoiceChat(gSavedSettings,"EnableVoiceChat");
	static LLCachedControl<bool> CmdLineDisableVoice(gSavedSettings,"CmdLineDisableVoice");
	return EnableVoiceChat && !CmdLineDisableVoice;
}
