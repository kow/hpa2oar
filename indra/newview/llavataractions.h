...
public:
	...
	/**
	 * Checks whether can have the position of the avatar
	 * Checks LLWorld and loops through the regions;
	 */
	static bool isNearby(const LLUUID& id);
