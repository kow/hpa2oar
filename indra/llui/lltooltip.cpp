...
{
	static LLUICachedControl<F32> ToolTipDelay("ToolTipDelay", 0);
	delay_time = ToolTipDelay;
	static LLUICachedControl<F32> ToolTipVisibleTimeOver("ToolTipVisibleTimeOver", 0);
	visible_time_over = ToolTipVisibleTimeOver;
	static LLUICachedControl<F32> ToolTipVisibleTimeNear("ToolTipVisibleTimeNear", 0);
	visible_time_near = ToolTipVisibleTimeNear;
	static LLUICachedControl<F32> ToolTipVisibleTimeFar("ToolTipVisibleTimeFar", 0);
	visible_time_far = ToolTipVisibleTimeFar;
	chrome = true;
}
